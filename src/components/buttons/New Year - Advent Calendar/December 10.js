...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const result = await userData.seasonal.new_year.advent_calendar.find(cal => cal.name = `Dec 10`)
        ...
        await interaction.reply({
            content: `Вы получили свою награду за 10-е декабря! Вы можете найти её в своем профиле!`,
            ephemeral: true
        })

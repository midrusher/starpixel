export declare namespace Components {
    ...
    namespace Responses {
        type MalformedUUID = Schemas.ApiError;
        type MissingFields = Schemas.ApiError;
        type RateLimitError = Schemas.ApiError;
        type Unauthorized = Schemas.ApiError;
    }
    namespace Schemas {
        /**
        ...
        interface AchievementsResourceResponse {
            /**
             ...
             */
            achievements: {
                [name: string]: AchievementGameModeData;
                arcade: AchievementGameModeData;
                arena: AchievementGameModeData;
                bedwars: AchievementGameModeData;
                blitz: AchievementGameModeData;
                buildbattle: AchievementGameModeData;
                christmas2017: AchievementGameModeData;
                copsandcrims: AchievementGameModeData;
                duels: AchievementGameModeData;
                easter: AchievementGameModeData;
                general: AchievementGameModeData;
                gingerbread: AchievementGameModeData;
                halloween2017: AchievementGameModeData;
                housing: AchievementGameModeData;
                murdermystery: AchievementGameModeData;
                paintball: AchievementGameModeData;
                pit: AchievementGameModeData;
                quake: AchievementGameModeData;
                skyblock: AchievementGameModeData;
                skyclash: AchievementGameModeData;
                skywars: AchievementGameModeData;
                speeduhc: AchievementGameModeData;
                summer: AchievementGameModeData;
                supersmash: AchievementGameModeData;
                tntgames: AchievementGameModeData;
                truecombat: AchievementGameModeData;
                uhc: AchievementGameModeData;
                vampirez: AchievementGameModeData;
                walls: AchievementGameModeData;
                walls3: AchievementGameModeData;
                warlords: AchievementGameModeData;
            };
        }
        interface ApiError {
            /**
        ...
        interface ChallengesResourceResponse {
            /**
             * Whether or not the request succeeded.
             */
            success: boolean;
        ...
        interface GuildsTieredAchievementsData {
            name: string;
            description: string;
            tiers: {
                tier: number;
         ...
         */
        interface Player {
            [name: string]: undefined | string | number | boolean | string[] | number[]
            /**
             ...
             *
             */
             | PlayerAdventRewards | PlayerAchievementTotem
            /**
             ...
             *
             */
             | PlayerChallenges | PlayerCompassStats | PlayerCooldowns
            /**
            ...
            petConsumables?: PlayerPetConsumables;
            ...
            monthlycrates?: PlayerMonthlyCrates;
            /**
             * This property represents a version - e.g. "v0.75"
             */
            network_update_book?: string;
            parkourCheckpointBests?: PlayerParkourCheckpointBests;
            parkourCompletions?: PlayerParkourCompletions;
            ...
            adventRewards2017?: PlayerAdventRewards;
            adventRewards2018?: PlayerAdventRewards;
            adventRewards_v2_2018?: PlayerAdventRewards;
            adventRewards2019?: PlayerAdventRewards;
            adventRewards_v2_2019?: PlayerAdventRewards;
            christmas2019Cooldowns?: PlayerEventCooldown;
            summer2020Cooldowns?: PlayerEventCooldown;
            easter2020Cooldowns?: PlayerEventCooldown;
            easter2020Cooldowns2?: PlayerEventCooldown;
            halloween2016Cooldowns?: PlayerEventCooldown;
            halloween2020Cooldowns?: PlayerEventCooldown;
            holiday2016Cooldowns?: PlayerEventCooldown;
            specialtyCooldowns?: PlayerEventCooldown;
            upcomingLanguageRelease_Korean?: PlayerUpcomingLanguageRelease;
            upcomingLanguageRelease_Portuguese?: PlayerUpcomingLanguageRelease;
            upcomingLanguageRelease_Russian?: PlayerUpcomingLanguageRelease;
            plotResets?: PlayerPlotResets;
            achievementPoints: number;
            achievementRewardsNew?: PlayerAchievementRewardsNew;
         ...
         */
        interface PlayerAchievementRewardsNew {
            [name: string]: number;
        }
        interface PlayerAchievementSync {
            [name: string]: number;
            quake_tiered: number;
        }
        interface PlayerAchievementTotem {
         ...
         *
         */
        interface PlayerChallenges {
            [name: string]: PlayerChallengesObject;
            all_time: PlayerChallengesObject;
        }
        /**
         ...
         *
         */
        interface PlayerChallengesObject {
            [name: string]: number;
        }
        interface PlayerCompassStats {
            compass?: PlayerCompassStatsChild;
            npc?: PlayerCompassStatsChild;
        }
        interface PlayerCompassStatsChild {
            [name: string]: undefined | number;
            arcade?: number;
            arena?: number;
            battleground?: number;
        ...
        interface PlayerFriendsData {
            [name: string]: undefined | string[];
            friendBlocksUuid?: string[];
            friendRequests?: string[];
            friendRequestsUuid?: string[];
        }
        interface PlayerGiftingMeta {
        ...
        interface PlayerHousingMetaPlayerSettings {
        ...
        interface PlayerIndividualPetStatsCare {
            timestamp: number;
            value: number;
        }
         ...
         */
        interface PlayerParkourCheckpointBests {
            [name: string]: {
                [name: string]: number;
            };
        }
         ...
         * Each property key describes the location of the parkour. e.g. "Prototype" or "Bedwars".
         */
        interface PlayerParkourCompletions {
            [name: string]: {
                /**
        ...
        interface PlayerSettings {
            [name: string]: undefined | boolean | string | number | {
                [name: string]: string;
            };
            compass?: {
                [name: string]: string;
        ...
        type PlayerSocialMedia = PlayerSocialMediaLinks & {
            [name: string]: string | boolean | PlayerSocialMediaLinks;
            links: PlayerSocialMediaLinks;
            prompt: boolean;
        };
        interface PlayerSocialMediaLinks {
            [name: string]: undefined | string;
            DISCORD?: string;
            HYPIXEL?: string;
            INSTAGRAM?: string;
        ...
        interface PlayerStats {
            [name: string]: undefined | PlayerStatsGameMode | /* Stats for bedwars. */ PlayerStatsBedwars | PlayerStatsPit | /* An object which properties describe each individual profile the player is a member of. */ PlayerStatsSkyBlock | PlayerStatsWalls3
            /**
         ...
         * Stats for bedwars.
         */
        type PlayerStatsBedwars = PlayerStatsGameMode & PlayerStatsBedwarsInfo & PlayerStatsBedwarsStats;
        /**
        ...
        interface PlayerStatsBedwarsPrivateGamesSettings {
        ...
        interface PlayerStatsHousingLayoutItems {
            [name: string]: string;
        }
        interface PlayerStatsPit {
        ...
        interface PlayerStatsPitProfile {
            ...
            outgoing_offers?: PlayerStatsPitProfileOutgoingOffer[];
        ...
        interface PlayerStatsPitProfileBounty {
            amount: number;
            issuer: string;
         ...
         */
        interface PlayerStatsPitProfileContractRequirements {
            [name: string]: undefined | number;
        }
        interface PlayerStatsPitProfileEndedContract {
            [name: string]: undefined | number | string | /* Property key is the type of requirement. */ PlayerStatsPitProfileContractRequirements;
            chunk_of_viles_reward?: number;
            completion_date: number;
            difficulty: string;
        ...
        interface PlayerStatsPitProfileInventory {
            data: number[];
            type: number;
        }
        interface PlayerStatsPitProfileLastBoughtItems {
            [name: string]: number;
        }
        interface PlayerStatsPitProfileLeaderboardStats {
            [name: string]: number;
        }
        /**
         * No properties known.
         */
        interface PlayerStatsPitProfileOutgoingOffer {
            [name: string]: unknown;
        }
        interface PlayerStatsPitProfilePrestige {
            index: number;
            timestamp: number;
            xp_on_prestige: number;
        }
        interface PlayerStatsPitProfileTransaction {
            amount: number;
            timestamp: number;
        }
        interface PlayerStatsPitProfileUnlock {
            acquireDate: number;
            key: string;
            tier: number;
        }
        ...
        interface PlayerTourney {
            [name: string]: undefined | number | string | boolean | {
                [name: string]: number;
        ...
        interface PlayerTourneyGameData {
         ...
         *
         */
        interface PlayerUpcomingLanguageRelease {
            logins: number;
        }
        interface PlayerVanityMeta {
            packages: string[];
        }
        interface PlayerVoting {
            [name: string]: undefined | number;
            last_mcf?: number;
            last_mcipl?: number;
            last_mcmp?: number;
        ...
        interface QuestsResourceResponse {
            /**
             * Whether or not the request succeeded.
             */
            success: boolean;
        ...
        interface SkyBlockBazaarProduct {
            product_id: string;
            sell_summary: {
                amount: number;
                pricePerUnit: number;
        ...
        interface SkyBlockBazaarResponse {
            /**
             * Whether or not the request succeeded.
             */
            success: boolean;
        ...
        interface SkyBlockProfileBankingTransaction {
            action: string;
            amount: number;
        ...
        interface SkyBlockProfileCollectionsAPI {
         ...
         */
        type SkyBlockProfileDungeonBlahBlah = string[];
        interface SkyBlockProfileDungeonClass {
            experience: number;
        }
        interface SkyBlockProfileDungeonJournal {
            journal_entries?: {
        ...
        type SkyBlockProfileDungeonJournalEntries = number[];
        ...
        type SkyBlockProfileDungeonTypeFloorRun = {
            ally_healing?: number;
            damage_dealt: number;
        ...
        interface SkyBlockProfileInventoryAPI {
        ...
        interface SkyBlockProfileMember {
            ...
            coin_purse: number;
            coop_invitation?: SkyBlockProfileCoopInvitation;
            /**
            ...
            dungeons?: {
                ...
                dungeons_blah_blah?: SkyBlockProfileDungeonBlahBlah;
                player_classes: {
            ...
            slayer_quest?: SkyBlockProfileSlayerQuest;
        ...
        interface SkyBlockProfileMemberBase {
            /**
             * An array of values, each value describing an island that has been spawned by the member. e.g. "Pond Island"
             */
            achievement_spawned_island_types?: string[];
        ...
        interface SkyBlockProfileObjective {
            [name: string]: undefined | boolean | number | string;
            completed_at: number;
            progress: number;
            status: string;
        }
        interface SkyBlockProfileObjectives {
        ...
        type SkyBlockProfilePets = SkyBlockProfilePet[];
        interface SkyBlockProfileQuest {
            activated_at: number;
        ...
        interface SkyBlockProfileQuests {
         ...
         */
        interface SkyBlockProfileSacksCounts {
            [name: string]: undefined | number;
            BLAZE_ROD?: number;
            BONE?: number;
            CACTUS?: number;
        ...
        interface SkyBlockProfileSkillsAPI {
            experience_skill_alchemy?: number;
            experience_skill_carpentry?: number;
            experience_skill_combat?: number;
            experience_skill_enchanting?: number;
        ...
        interface SkyBlockProfileSlayerBoss {
            [name: string]: undefined | number | {
                [name: string]: undefined | boolean;
            };
        ...
        interface SkyBlockProfileSlayerBosses {
        ...
        interface SkyBlockResourcesParentCollection {
            /**
         ...
         */
        interface SkyBlockResourcesParentCollections {
         ...
         */
        interface SkyBlockResourcesSkills {
        ...
        interface SkyBlockSkillsResourcesResponse {
            /**
             * Whether or not the request succeeded.
             */
            success: boolean;
             ...
             */
            version: string;
            collections: SkyBlockResourcesSkills;
        }
    }
}
export declare namespace Paths {
    namespace Boosters {
        namespace Get {
            namespace Responses {
                ...
                type $400 = Components.Responses.MissingFields;
                type $403 = Components.Responses.Unauthorized;
                type $429 = Components.Responses.RateLimitError;
            }
        }
    }
    namespace FindGuild {
        namespace Get {
            namespace Responses {
                ...
                type $400 = Components.Schemas.ApiError;
                type $403 = Components.Responses.Unauthorized;
                type $422 = Components.Responses.MalformedUUID;
                type $429 = Components.Responses.RateLimitError;
            }
        }
    }
    ...
    namespace Guild {
        namespace Get {
            ...
            namespace Responses {
                type $200 = Components.Schemas.GuildResponse;
                type $400 = Components.Schemas.ApiError;
                type $403 = Components.Responses.Unauthorized;
                type $422 = Components.Schemas.ApiError;
                type $429 = Components.Responses.RateLimitError;
            }
        }
    }
    ...
    namespace ResourcesAchievements {
        namespace Get {
            namespace Responses {
                 ...
                 * }
                 */
                type $200 = Components.Schemas.AchievementsResourceResponse;
            }
        }
    }
    namespace ResourcesChallenges {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.ChallengesResourceResponse;
            }
        }
    }
    namespace ResourcesGuildsAchievements {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.GuildsAchievementsResourceResponse;
            }
        }
    }
    namespace ResourcesGuildsPermissions {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.GuildsPermissionsResourceResponse;
            }
        }
    }
    namespace ResourcesQuests {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.QuestsResourceResponse;
            }
        }
    }
    namespace ResourcesSkyblockCollections {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.SkyBlockCollectionsResourcesResponse;
            }
        }
    }
    namespace ResourcesSkyblockSkills {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.SkyBlockSkillsResourcesResponse;
            }
        }
    }
    namespace SkyblockAuction {
        namespace Get {
            ...
            namespace Responses {
                type $200 = Components.Schemas.SkyBlockAuctionResponse;
                type $400 = Components.Schemas.ApiError;
                type $403 = Components.Responses.Unauthorized;
                type $429 = Components.Responses.RateLimitError;
            }
    ...
    namespace SkyblockAuctions {
        namespace Get {
            ...
            namespace Responses {
                type $200 = Components.Schemas.SkyBlockAuctionsResponse;
            }
        }
    }
    namespace SkyblockAuctionsEnded {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.SkyBlockAuctionsEndedResponse;
            }
        }
    }
    namespace SkyblockBazaar {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.SkyBlockBazaarResponse;
            }
        }
    }
    namespace SkyblockNews {
        namespace Get {
            namespace Responses {
                type $200 = Components.Schemas.NewsResponse;
                type $400 = Components.Responses.MissingFields;
                type $403 = Components.Responses.Unauthorized;
                type $429 = Components.Responses.RateLimitError;
            }

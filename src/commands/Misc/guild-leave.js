...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        const g_leave_embed = new EmbedBuilder()
            ...
            .setDescription(`Перед тем как принять решение об уходе чётко спросите себя - не пожалеете ли вы об этом, ведь по правилам гильдии тот, кто покинул гильдию - не может в неё вернуться больше никогда. Если вы потеряли интерес к игре, то не спешите так быстро уходить из гильдии, ведь интерес может всегда вернуться. Наш совет для вас: перед тем как принять решение об уходе, свяжитесь с офицерами гильдии в <#${process.env.ask_channel}> и расскажите о своей ситуации. Если это какая-то депрессия, большое количество учёбы или же что-то в этом роде - мы обязательно найдём с вами решение. Главное не бойтесь написать!
